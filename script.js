...
let colors = ["lightred", "lightblue", "lightpur", "lightgreen"];
...
function handleRemoval(ticket, id){
    // removeFlag is true then remove ticket
    ticket.addEventListener("click", (e)=>{
        ...
        // db removal
        ticketsArr.splice(idx, 1);  // remove from current array
